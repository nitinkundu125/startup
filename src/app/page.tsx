    ...
    <div className="space-y-8">
      ...
      <DashboardView
        initialOverall={{
          ...
          monthlyCashFlows: overallSummary.monthlyCashFlows,
          totalDividends: overallSummary.totalDividends,
        ...
        initialStocks={{
          ...
          monthlyCashFlows: stockSummary.monthlyCashFlows,
          totalDividends: stockSummary.totalDividends,
        ...
        initialMf={{
          ...
          monthlyCashFlows: mfSummary.monthlyCashFlows,
          totalDividends: mfSummary.totalDividends,
          xirr: mfSummary.xirr,
        ...
        initialUsStocks={{
          ...
          monthlyCashFlows: usStockSummary.monthlyCashFlows,
          totalDividends: usStockSummary.totalDividends,
